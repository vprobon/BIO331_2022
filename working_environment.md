...
Η διδασκαλία (Μάθημα και Φροντιστήρια) θα πραμγατοποιείται στο  Εργαστήριο Υπολογιστών του Τμήματος Χημείας ΘΕΕ02/010. Οι υπολογιστές του εργαστηρίου λειτουργούν με ΛΣ Windows.
...
Αυτό σημαίνει πως μπορείτε να δουλέψετε από οπουδήποτε αρκεί να έχετε μια συσκευή (Η/Υ, τάμπλετ κλπ) με ένα σύγχρονο web browser και πρόβαση στο διαδίκτυο. 
