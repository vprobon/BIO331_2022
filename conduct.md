...
5. Η τελική εξέταση θα πραγματοποιηθεί στο εργαστήριο, με τη χρήση Η/Υ και θα περιλαμβάνει και προφορικό μέρος με σκοπό την αξιολόγηση της σε βάθος κατανόησης εννοιών που έχουν διδαχθεί. Η χρήση σημειώσεων κλπ επιτρέπεται ("ανοιχτά" βιβλία/σημειώσεις).
